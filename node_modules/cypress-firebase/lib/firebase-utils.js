...
exports.deleteCollection = exports.slashPathToFirestoreRef = exports.isDocPath = exports.initializeFirebase = exports.isString = void 0;
...
function initializeFirebase(adminInstance, overrideConfig) {
    ...
    try {
        ...
        if (!fbConfig.projectId) {
            const projectId = process.env.GCLOUD_PROJECT || ((_a = fbConfig.credential) === null || _a === void 0 ? void 0 : _a.projectId); // eslint-disable-line camelcase
            if (projectId) {
...
function deleteCollection(db, refOrQuery, options) {
    ...
    if (!(options === null || options === void 0 ? void 0 : options.limit)) {
        baseQuery = refOrQuery.limit((options === null || options === void 0 ? void 0 : options.batchSize) || 500);
    }
